...
public class SettingsAnounceNotiFragment extends PreferenceFragment implements
	...
	public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen,
		...
		case R.string.setting_check_anounce_service:
	...
	private void bindPreferenceSummaryToValue() {
		...
		String[] keys = { PrefUtil.KEY_KEYWORD_ANOUNCE,
				PrefUtil.KEY_CHECK_ANOUNCE_SERVICE, PrefUtil.KEY_NOTI_TIME };
		for (String key : keys) {
	...
	public void onSharedPreferenceChanged(SharedPreferences sharedPreferences,
			String key) {
		if (key.equals(PrefUtil.KEY_KEYWORD_ANOUNCE)) {
		...
		} else if (key.equals(PrefUtil.KEY_CHECK_ANOUNCE_SERVICE)) {
			Preference connectionPref = findPreference(key);
			if (sharedPreferences.getBoolean(key, false)) {
				connectionPref
						.setSummary(R.string.setting_check_anounce_service_desc_enable);
			} else {
				connectionPref
						.setSummary(R.string.setting_check_anounce_service_desc_disable);
			}
			AppUtil.startOrStopServiceAnounce(getActivity());
		}
	}
					...
					new OnTimeSetListener() {
						...
						public void onTimeSet(TimePicker view, int hourOfDay,
							...
							onSharedPreferenceChanged(getPreferenceScreen()
									...
									PrefUtil.KEY_NOTI_TIME);
						}
					}, hour, min, false);
			timePicker.setTitle(R.string.setting_noti_time);
			timePicker.setCancelable(true);
			timePicker.setButton(DialogInterface.BUTTON_POSITIVE,
					getText(android.R.string.ok), new OnClickListener() {

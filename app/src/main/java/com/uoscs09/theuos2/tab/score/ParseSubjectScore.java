...
@Deprecated
public class ParseSubjectScore {}/*extends OApiParser<ScoreItem, ArrayList<String>> {
    private final String[] PTN = {"subject_nm", "subject_no", "classDiv", "class_person", "prof_nm", "dept"};

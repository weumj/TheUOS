...
public class SimpleTextViewAdapter extends AbsArrayAdapter<Integer, Holder> {
    ...
    public void onBindViewHolder(int position, Holder holder) {
        ...
        switch (this.position) {
            ...
            case RIGHT:
                if (drawableBound != null) {
                    ...
                    holder.tv.setCompoundDrawablesWithIntrinsicBounds(null, null, d, null);
                break;
            default:
                if (drawableBound != null) {
                    d.setBounds(drawableBound);
        ...
        holder.tv.setTextColor(textViewTextColor == 0 ? getContext().getResources()
                .getColor(AppUtil.getAttrValue(getContext(), android.R.attr.colorForeground)) : textViewTextColor);
    }

...
public class AsyncLoader {
     ...
     */
    public static <Data> AsyncTask<Void, Void, Data> excute(Callable<Data> task, AsyncCallback<Data> callback) {
        return new AsyncExecutor<Data>().setCallable(task).setCallback(callback).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    }

...
public class SettingsAnounceNotiFragment extends PreferenceFragment implements
	...
	public void onResume() {
		...
		activity.getSupportActionBar().setTitle(
				R.string.setting_announce_noti_frag_title1);
	...
	public void onSharedPreferenceChanged(SharedPreferences sharedPreferences,
		...
		if (key.equals(PrefUtil.KEY_KEYWORD_ANOUNCE)) {
			...
			if (sharedPreferences.getBoolean(key, false)) {
				connectionPref
						.setSummary(R.string.setting_check_announce_service_desc_enable);
			} else {
				connectionPref
						.setSummary(R.string.setting_check_announce_service_desc_disable);
			}
			AppUtil.startOrStopServiceAnounce(getActivity());
		}
	}

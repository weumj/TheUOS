...
public class PrefUtil {
	 ...
	 *             기존에 저장된 값의 Type이 {@code boolean}이 아닐 때
	 */
	...
	/**
	 * @throws ClassCastException
	 *             기존에 저장된 값의 Type이 {@code int}가 아닐 때
	 */
	...
	/**
	 * @throws ClassCastException
	 *             기존에 저장된 값의 Type이 {@code String}이 아닐 때
	 */
	...
	/**
	 * @throws ClassCastException
	 *             기존에 저장된 값의 Type이 {@code float}이 아닐 때
	 */
	...
	/**
	 * @throws ClassCastException
	 *             기존에 저장된 값의 Type이 {@code long}이 아닐 때
	 */
	...
	/**
	 * @throws ClassCastException
	 *             기존에 저장된 값의 Type이 {@code Set<String>}이 아닐 때
	 */

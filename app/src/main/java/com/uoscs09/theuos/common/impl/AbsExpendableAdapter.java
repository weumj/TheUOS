...
public abstract class AbsExpendableAdapter<K, V> extends
		BaseExpandableListAdapter {
	private Map<K, ? extends List<V>> mGroupData;
	...
	public AbsExpendableAdapter(Context context, int grouplayout,
		...
		this.mKeys = data.keySet().toArray();
	...
	protected abstract void setGroupView(int groupPosition, boolean isExpanded,
			View v, ViewGroup parent, ViewHolder h);
	...
	public void notifyDataSetChanged() {
		this.mKeys = mGroupData.keySet().toArray();

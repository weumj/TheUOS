...
public class ColorSelector extends android.app.Dialog implements OnValueChangedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mdl_color_selector);
    ...
    public void show() {
        super.show();
        view.startAnimation(AnimationUtils.loadAnimation(context, R.anim.mdl_dialog_main_show_amination));
        backView.startAnimation(AnimationUtils.loadAnimation(context, R.anim.mdl_dialog_root_show_amin));
    }
    ...
    @Override
    public void dismiss() {
        Animation anim = AnimationUtils.loadAnimation(context, R.anim.mdl_dialog_main_hide_amination);
        ...
        Animation backAnim = AnimationUtils.loadAnimation(context, R.anim.mdl_dialog_root_hide_amin);

...
public class Slider extends CustomView {
    ...
    private Paint mPaint = new Paint(), mTransparentPaint = new Paint();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (value == min) {
            ...
            temp.drawCircle(ViewHelper.getX(ball) + ball.getWidth() / 2, ViewHelper.getY(ball) + ball.getHeight() / 2, ball.getWidth() / 2, mTransparentPaint);
    ...
    protected void setAttributes(AttributeSet attrs) {
        ...
        setBackgroundResource(R.drawable.mdl_background_transparent);
    ...
    class Ball extends View {
        ...
        public Ball(Context context) {
            super(context);
            setBackgroundResource(R.drawable.mdl_background_switch_ball_uncheck);
        }

        public void changeBackground() {
            if (value != min) {
                setBackgroundResource(R.drawable.mdl_background_checkbox);
    ...
    class NumberIndicator extends Dialog {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.mdl_number_indicator_spinner);
